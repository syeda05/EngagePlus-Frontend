...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF882C41);
  late Color secondary = const Color(0xFFFF9500);
  late Color tertiary = const Color(0xFF31304E);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFFFFFFFF);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFFFD469);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xFF8C8989);
  late Color success = const Color(0xFF57A117);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFE11D1D);
